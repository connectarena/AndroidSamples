            ...
            builderDialog.setPositiveButton("Ok",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog,
                            ...
                            showProgressbar();
//                            CSAppDetails csAppDetails = new CSAppDetails("CallSample", "pid_d40a3614_75e8_4526_92b9_5c62c07c243f    ");// mine
//                            CSAppDetails csAppDetails = new CSAppDetails("CallSample", "pid_39684a6d_5103_4254_9775_1b923b9b98d5");
                            CSAppDetails csAppDetails = new CSAppDetails("CallSample", "pid_06b45d1b_43ac_4d5d_8a9b_8c935391e33e");
                ...
                if (intent.getAction().equals(CSEvents.CSCLIENT_NETWORKERROR)) {
                    ...
                    if (intent.getStringExtra(CSConstants.RESULT).equals(CSConstants.RESULT_SUCCESS)) {
                        if (!CSDataProvider.getSignUpstatus()) {
                            ...
                            CSClientObj.enableNativeContacts(CSConstants.NATIVECONTACTS.READANDSYNCWITHSERVER, 91);

                            // This will call SignUp API to generate OTP
                            CSClientObj.signUp(Constants.phoneNumber, Constants.password, CSConstants.CSCLIENT_OTPTYPE.SMS , "");
                        }
                    } else {
                        dismissProgressbar();
