...
public class PlayNewAudioCallActivity extends Activity {
        ...
        try {
            ...
            try {
                ...
                if (getIntent().getBooleanExtra("isinitiatior", false)) {
                    ...
                    Log.i("Call Events","dstnumber: "+mDestinationNumberToCall);
                    myCallId = CSCallObj.startPstnCall(mDestinationNumberToCall,"89765","",new CSLocation(0.00,0.00,""),true,CSConstants.CALLRECORD.DONTRECORD);
                } else {
                    ...
                    CSCallObj.answerPstnCall(mDestinationNumberToCall, getIntent().getStringExtra("callid"),"",new CSLocation(0.00,0.00,""));
                }
            ...
            mAudioEndCallImg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    try {
                        ...
                        CSCallObj.endPstnCall(mDestinationNumberToCall, myCallId);
                        endTheCall();
                    } catch (Exception ex) {
                        ex.printStackTrace();
                    }
                    ...
                    try {
                        ...
                        if (!myCallId.equals("")) {
                            ...
                            if (isHoldEnabled) {
                                ...
                                CSCallObj.holdPstnCall( myCallId, true);
                            } else {
                                // This will UnHold the running Audio call
                                CSCallObj.holdPstnCall( myCallId, false);
                            }
    ...
    public class MainActivityReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            try {
                Log.i("Call Events","Received event: "+intent.getAction().toString());
