...
import static com.ca.callsample.MainActivity.context;
...
//                Toast.makeText(getApplicationContext(),"158--------",Toast.LENGTH_LONG).show();
...
//                Toast.makeText(getApplicationContext(),"158--------",Toast.LENGTH_LONG).show();
        ...
        //    context.registerReceiver(NotificationReceiver, new IntentFilter("NotificationHandleReceiver"));
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                registerReceiver(NotificationReceiver, new IntentFilter("NotificationHandleReceiver"), RECEIVER_EXPORTED);
            } else {
//                @Suppress("UnspecifiedRegisterReceiverFlag")
        ...
        //            Toast.makeText(getApplicationContext(),"213+ ENDclick",Toast.LENGTH_LONG).show();
                    try {
    ...
    public void answerCall() {
        try {
            ...
            if (callType.equals("video")) {
                ...
                intent1 = new Intent(context, PlayNewVideoCallActivity.class);
            } else {

                intent1 = new Intent(context, PlayNewAudioCallActivity.class);
            }
