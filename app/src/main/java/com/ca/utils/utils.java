...
//        PendingIntent pIntent = PendingIntent.getActivity(context, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            pIntent = PendingIntent.getActivity(MainActivity.context,
        ...
        PendingIntent endCallIntent = PendingIntent.getBroadcast(context, 1, intentAction, PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_IMMUTABLE);
    ...
    //    PendingIntent answerCallIntent = PendingIntent.getBroadcast(context, 1, intentAction1, PendingIntent.FLAG_CANCEL_CURRENT);
        ...
        PendingIntent answerCallIntent;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            answerCallIntent = PendingIntent.getActivity(MainActivity.context,
                    0, intentAction1, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);

        }else {
            answerCallIntent = PendingIntent.getActivity(MainActivity.context,
                    0, intentAction1, PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_IMMUTABLE);
    ...
    public static int notifyCallMissed(Context context, String number, String name, String callid, String calldirection, String calltime, int reqcode) {
        ...
        try {
            ...
            PendingIntent pIntent = PendingIntent.getBroadcast(context, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
            PendingIntent pIntent1 = PendingIntent.getActivity(context, 0, intent1, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
...
//
//                                Log.d("440--------",secondcall + "1----"+sDstMobNu+ ""+ callactive
//                                +""+callType +"" +srcnumber +""+callid +"" +callstarttime);
                            }
