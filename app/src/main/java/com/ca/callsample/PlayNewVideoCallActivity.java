        ...
        try {
            ...
            try {
                ...
                if (getIntent().getBooleanExtra("isinitiatior", false)) {
                    ...
                    myCallId = CSCallObj.startVideoCall(mDestinationNumberToCall, localRender, remoteRender,CSConstants.CALLRECORD.DONTRECORD,"",new CSLocation(0.00,0.00,""));
                } else {
                    ...
                    CSCallObj.answerVideoCall(mDestinationNumberToCall, getIntent().getStringExtra("callid"), localRender, remoteRender,"",new CSLocation(0.00,0.00,""));
                }
